                        ...
                        <div ref={ref} className="hero__content">
                            <div className='hero__content__header'>
                                <Zoom triggerOnce cascade>
                                    <h4 className="text--lead text-white">Los Angeles CA 90056
                                    </h4>
                                    <h1 className="text--title text-white">5204 Bedford Ave<br /> <span className="text--subtitle">Just Sold for $1,060,000</span>
                                    </h1>
                                    <h4 className="text--lead text-white mb-5">We Have Qualified Buyers Ready!
                                    </h4>
                                    <a className="btn btn--primary" target="__blank" href="sms:+13106334350?body=Hi%2C%20I'm%20interested%20in%20the%20property%205204%20Bedford%20Ave.%20Please%20contact%20me.">Schedule Your Free Consultation</a>
